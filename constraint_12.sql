-- @C:\Oracledatabase\CSY1026\constraint_12.sql
...
ALTER TABLE team_players
ADD CONSTRAINT fk_tpl_players
FOREIGN KEY (player_id)
REFERENCES players (player_id); 

ALTER TABLE team_players
ADD CONSTRAINT fk_tpl_teams
FOREIGN KEY (team_id)
...
REFERENCES tournament_participants(player_id, team_id, tournament_id);
